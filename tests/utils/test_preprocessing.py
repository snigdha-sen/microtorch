...
from microtorch.utils.preprocessing import direction_average, img2voxel, normalise, voxel2img
...
class DummyGrad:
    def __init__(self, scheme_matrix, bvalues=None):
        ...
        self.number_of_measurements = scheme_matrix.shape[0] if scheme_matrix is not None else None
...
def test_direction_average_basic():
    ...
    img = torch.tensor([[[[1.0, 3.0, 10.0, 14.0]]]])  # shape (1,1,1,4)
